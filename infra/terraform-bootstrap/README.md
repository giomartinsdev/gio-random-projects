...
Creates the R2 bucket (`gio-homelab-tfstate`) that `infra/terraform`'s
...
against it (`infra/terraform/README.md` step 2) and configure
`infra/terraform`'s backend with those credentials.
