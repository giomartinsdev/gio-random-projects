...
// bookclub-api/post-api's own copy of this same file (token bucket
// per IP, idle buckets evicted so this can't leak memory against an
// endless stream of distinct IPs).
